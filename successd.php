<?php 
    require_once 'db/conn.php';
        $id = $_GET['id'];
        $result = $crud->deleteCst($id);
?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	<title>Sukses Menghapus</title>
...
<div class="container">
    ...
    <br>
    <br>
    <h2 style="text-align: center;">Data Dihapus</h2>
    <p style="text-align: center;">Semoga data yang dihapus tidak tejadi kesalahan</p>
